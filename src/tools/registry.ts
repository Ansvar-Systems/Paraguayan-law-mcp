/**
 * Tool registry for Paraguay Law MCP Server.
...
import { getParaguayanImplementations, type GetParaguayanImplementationsInput } from './get-paraguayan-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Paraguay Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Paraguayan legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Paraguayan statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Paraguayan statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Paraguayan legal citation against the database — zero-hallucination check. ' +
      ...
      'Supports formats: "Section 25, Data Protection Act 2019", "s 25, DPA 2019", "Article 31, Constitution of Paraguay 2010".',
    inputSchema: {
      type: 'object',
      properties: {
        citation: {
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Paraguayan statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Paraguay?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Paraguayan legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Paraguayan statute or provision is currently in force, amended, repealed, partially suspended, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Paraguayan statute aligns with or references. ' +
      'Paraguay is not an EU member but several Paraguayan laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Paraguayan statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_paraguayan_implementations',
    description:
      'Find all Paraguayan statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Paraguayan statutes. ' +
      'Note: Paraguay implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Paraguayan implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_paraguayan_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Paraguayan aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Paraguayan statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Paraguayan statute or provision. ' +
...
const EU_TOOL_NAMES = new Set([
  'get_eu_basis',
  'get_paraguayan_implementations',
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_paraguayan_implementations':
          result = await getParaguayanImplementations(db, args as unknown as GetParaguayanImplementationsInput);
          break;
