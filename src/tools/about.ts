...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Paraguay Law MCP',
    version: context.version,
    jurisdiction: 'PY',
    description: 'Paraguay Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'BACN (Biblioteca y Archivo Central del Congreso)',
        url: 'https://bacn.gov.py',
        authority: 'Congreso Nacional de Paraguay',
      },
    ],
    freshness: {
