...
## [1.0.0] - 2026-XX-XX
### Added
- Initial release of Paraguay Law MCP
- `search_legislation` tool for full-text search across all Paraguayan statutes
...
[Unreleased]: https://github.com/Ansvar-Systems/paraguay-law-mcp/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/Ansvar-Systems/paraguay-law-mcp/compare/v1.0.0...v1.1.0
[1.0.0]: https://github.com/Ansvar-Systems/paraguay-law-mcp/releases/tag/v1.0.0
