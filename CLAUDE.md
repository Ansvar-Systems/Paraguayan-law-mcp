# Paraguay Law MCP Server — Developer Guide
...
Paraguay Law MCP server providing Paraguayan legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Paraguay uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Paraguay Law -> JSON seed files in `data/seed/`
...
- **Paraguay Law** (paraguaylaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Paraguay 2010, selected case law

## Paraguay-Specific Notes

- Paraguay uses a common law legal system inherited from British colonial administration
- The Constitution of Paraguay 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Paraguay 2010"
...
- npm package: `@ansvar/paraguay-law-mcp` with bin entry for stdio
